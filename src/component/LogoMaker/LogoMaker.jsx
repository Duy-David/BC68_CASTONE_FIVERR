...
const LogoMaker = () => {
  ...
  return (
    <section
      className=" text-black p-8 md:p-16 rounded-lg container my-20"
      ...
      <div className="md:flex items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          ...
          <h3 className="text-6xl font-normal my-4">
            {t("Make an incredible logo ")}{" "}
            <span className="font-normal font-ddisplay text-orange-500">
              {t("in seconds")}
            </span>
          </h3>
          <p className="mt-10 mb-6 text-gray-500 text-xl">
            {" "}
            {t(" Pre-designed by top talent. Just add your touch")}
          </p>
