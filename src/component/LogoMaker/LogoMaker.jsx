  ...
  return (
    ...
    <div className="md:flex items-center">
      <div className="md:w-1/2 mb-8 md:mb-0">
        ...
        Make an incredible logo <span className="font-normal text-orange-500">in seconds</span>
        </h3>
        <p className="mt-10 mb-6 text-gray-500 text-xl">  Pre-designed by top talent. Just add your touch
        </p>
